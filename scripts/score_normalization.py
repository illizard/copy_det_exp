...
if __name__ == "__main__":
    ...
    aa("--db_descs", default='data/subset_1_references_multigrain.hdf5', nargs='*', help="database descriptor file in HDF5 format")
    aa("--train_descs", default='data/train_{0..19}_multigrain.hdf5', nargs='*', help="training descriptor file in HDF5 format")
    aa("--query_descs", default='data/subset_1_queries_multigrain.hdf5', nargs='*', help="query descriptor file in HDF5 format")
    ...
    aa("--n", default=10, type=int, help="rank in training results to use for normalization")
    aa("--factor", default=2.0, type=float, help="weight of the normalization")
    ...
    aa("--o", default="./data/predictions_subset_dev_queries_normalized.csv", help="write predictions to this output file")
