...
def main():
    ...
    aa('--num_workers', default=28, type=int, help="nb of dataloader workers")

    group = parser.add_argument_group('model options')
    aa('--model', default='multigrain_resnet50', help="model to use")
    aa('--checkpoint', default='./models/multigrain_joint_3B_0.5.pth', help='override default checkpoint')
